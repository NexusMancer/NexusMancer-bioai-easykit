...
#          -> zero-shot training.
# Location: /home/shisk/NexusMancer-bioai-easykit/scripts/union/run_state_full_pipeline.sh
# =============================================================================

set -e  # Exit immediately if any command fails

# ====================== Configuration ======================
PROJECT_ROOT="/home/shisk/NexusMancer-bioai-easykit"
LOG_FILE="${PROJECT_ROOT}/logs/state_full_pipeline_$(date +%Y%m%d_%H%M%S).log"

# Paths to the three core scripts (absolute paths for maximum stability)
