...
# =====================================================
# Norman Gene Perturbation Dataset - CPA Training
...
OUTPUT_DIR="${PROJECT_ROOT}/logs/cpa_norman/"
...
echo "═══════════════════════════════════════════════"
echo "  📊 Training CPA on Norman Gene Perturbation Dataset"
echo "  Fold          : $FOLD_ID"
...
echo "✅ Training completed for CPA (fold ${FOLD_ID})"