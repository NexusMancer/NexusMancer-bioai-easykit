...
# =====================================================
# Norman Gene Perturbation Dataset - scGPT Training
...
OUTPUT_DIR="${PROJECT_ROOT}/logs/scgpt_norman/"
...
# scGPT requires special internal naming in this framework
INTERNAL_MODEL="scgpt-genetic"
TRAINING_NAME="scgpt"

echo "═══════════════════════════════════════════════"
echo "  📊 Training scGPT on Norman Gene Perturbation Dataset"
echo "  Fold          : $FOLD_ID"
...
echo "✅ Training completed for scGPT (fold ${FOLD_ID})"