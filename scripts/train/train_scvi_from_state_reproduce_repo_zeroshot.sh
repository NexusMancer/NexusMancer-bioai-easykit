...
# =====================================================
# Norman Gene Perturbation Dataset - scVI Training
...
OUTPUT_DIR="${PROJECT_ROOT}/logs/scvi_norman/"
...
echo "═══════════════════════════════════════════════"
echo "  📊 Training scVI on Norman Gene Perturbation Dataset"
echo "  Fold          : $FOLD_ID"
...
echo "✅ Training completed for scVI (fold ${FOLD_ID})"