...
# =====================================================
# Norman Gene Perturbation Dataset - LRLM Training
...
OUTPUT_DIR="${PROJECT_ROOT}/logs/lrlm_norman/"
...
echo "═══════════════════════════════════════════════"
echo "  📊 Training LRLM on Norman Gene Perturbation Dataset"
echo "  Fold          : $FOLD_ID"
...
python -m state_sets_reproduce.train \
    ...
    model.kwargs.gene_emb=scgpt \
    model.kwargs.pert_emb=scgpt \
...
echo "✅ Training completed for LRLM (fold ${FOLD_ID})"